...
const T={
  light:{bgApp:"#F7F5E8",bgSurface:"#FFFEF7",bgElevated:"#F3F0D8",bgSidebar:"linear-gradient(180deg,#1A4F92 0%,#1446A0 42%,#0F766E 100%)",bgSidebarActive:"#0F766E",text:"#17325C",textSec:"#0F766E",textMuted:"#6F6B52",textSidebar:"#EBEBD3",textSidebarActive:"#FFFFFF",border:"rgba(20,70,160,0.16)",borderCard:"rgba(15,118,110,0.16)",accent:"#0F766E",accentLight:"#EBEBD3",accentText:"#1446A0",grad:"linear-gradient(135deg,#1446A0 0%,#0F766E 42%,#DB3069 100%)",completed:{bg:"rgba(15,118,110,0.14)",text:"#0A5E58",dot:"#0F766E"},pending:{bg:"rgba(245,213,71,0.28)",text:"#8A6A00",dot:"#F5D547"},cancelled:{bg:"rgba(219,48,105,0.14)",text:"#B51F56",dot:"#DB3069"},confirmed:{bg:"rgba(20,70,160,0.12)",text:"#1446A0",dot:"#1446A0"},expired:{bg:"rgba(111,107,82,0.12)",text:"#6F6B52",dot:"#8F8A68"},admin:{bg:"rgba(219,48,105,0.10)",text:"#B51F56",dot:"#DB3069"},shadow:"0 12px 28px rgba(20,70,160,0.10)",shadowLg:"0 20px 48px rgba(20,70,160,0.16)"},
  dark:{bgApp:"#09162F",bgSurface:"#102348",bgElevated:"#16305F",bgSidebar:"linear-gradient(180deg,#12346F 0%,#102C61 44%,#0D5F59 100%)",bgSidebarActive:"#0F766E",text:"#F5F2DF",textSec:"#EBEBD3",textMuted:"#C8C7AF",textSidebar:"#EBEBD3",textSidebarActive:"#FFFFFF",border:"rgba(255,255,255,0.08)",borderCard:"rgba(235,235,211,0.10)",accent:"#F5D547",accentLight:"rgba(245,213,71,0.14)",accentText:"#F5D547",grad:"linear-gradient(135deg,#1446A0 0%,#0F766E 45%,#DB3069 100%)",completed:{bg:"rgba(15,118,110,0.20)",text:"#8FF0E9",dot:"#8FF0E9"},pending:{bg:"rgba(245,213,71,0.18)",text:"#F5D547",dot:"#F5D547"},cancelled:{bg:"rgba(219,48,105,0.18)",text:"#FF88AF",dot:"#FF88AF"},confirmed:{bg:"rgba(20,70,160,0.20)",text:"#9BBCFF",dot:"#9BBCFF"},expired:{bg:"rgba(235,235,211,0.10)",text:"#D5D5BE",dot:"#D5D5BE"},admin:{bg:"rgba(219,48,105,0.18)",text:"#FF88AF",dot:"#FF88AF"},shadow:"0 12px 28px rgba(6,17,42,0.30)",shadowLg:"0 20px 48px rgba(6,17,42,0.38)"},
};
...
export default function AdminPro({embedded=false,page:forcedPage,darkMode}){
  ...
  return(
    <div dir="rtl" style={{display:"flex",height: embedded?"100%":"100vh",overflow:"hidden",background:t.bgApp,fontFamily:"var(--font-body)"}}>
      {!embedded && <div className="hide-scrollbar" style={{width:collapsed?84:320,background:t.bgSidebar,display:"flex",flexDirection:"column",transition:"width 0.2s",flexShrink:0,boxShadow:"2px 0 18px rgba(0,0,0,0.18)"}}>
